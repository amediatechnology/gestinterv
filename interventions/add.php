...
$add_interv = "INSERT INTO tinterventions VALUES ('','$codeClient','','$dateInterv','$antivirus','$malwares','$spybot','$strLogiciels','$strMaj','$strVirus','$strReinstall','$strRam','$intervention','$materiel','$observation','$technicien','$prix');";
...
<div id="templatemo_main">
    ...
    <h2>Création de la fiche d'intervention n° <?php echo $codeIntervention; ?> - REUSSITE ! -</h2> <!-- TITRE -->
		<div class="col_w340"> <!-- CONTENUS -->		
			...
			La fiche de pré-intervention a quant à elle été <b>supprimée</b> !<br /><br />
			<form action="print_interv.php" method="post"> <input type="hidden" name="id" value="<?php echo $codeIntervention; ?>"> <input type="submit" value="IMPRIMER" style="width:250px; height:50px;font-size:14px;"></form>
