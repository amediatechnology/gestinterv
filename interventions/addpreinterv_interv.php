...
<tr> <th></th> <th></th> <th></th> <th></th> <th> Dossier Mes DOCUMENTS </th> <th> Dossiers spécifiques </th> </tr>';
...
switch ($materiel) { // Selon le matériel qui a été sélectionné, la page ne sera pas la même.
	case 'PC FIXE':
	include ('switch0.php'); // Page complète (logiciels, virus, obs...)
	break;
	...
	case 'IMPRIMANTE':
	include ('switch1.php'); // Page personnalisée (Observations, technicien)
	break;
