...
<?php
	if (empty($_POST))
	{ echo "<p>Pas de nouveau matériel ajouté</p><br /><hr /><br />"; }
...
// AFFICHAGE DES TYPES D'INTERVENTION
	...
	{					  
		...
		echo "<td align='center'><form action='deltypemateriel.php?id=".$ligne["id"]."' method='POST'> <input type='hidden' name='id' value='".$ligne["id"]."'> <input type='submit' class='button blue morph' value='Suppression' onclick=\"javascript:return(confirm('Confirmer la suppression ?'))\";> </form></td>" ;
		echo "</tr>" ;
	}
?>
</table>
